...
# Fetch the latest image_id from the no_of_benches field of the Classroom table
# classroom = Classroom.query.filter_by(classroom_no=classroom_n0).first()
# image_id = classroom.no_of_benches
...
while True:
    ...
    if key == ord('s'):
        ...
        # Update the no_of_benches field in the database with the latest image_id
        classroom.no_of_benches = image_id
    elif key == ord('q'):
        break
